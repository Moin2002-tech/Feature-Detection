...
namespace Classification
{
	...
	*/
	...
	public:
		...
		*/
		bool classify(std::pair<int, double> levelAndDistance);
		...
		*/
		...
		std::pair<bool, double> getConfidence(std::pair<int, double> levelAndDistance) ;
		/**
		 ...
		 */
		std::pair<int, double> hyperPlaneDistance(const cv::Mat& featureVector);
