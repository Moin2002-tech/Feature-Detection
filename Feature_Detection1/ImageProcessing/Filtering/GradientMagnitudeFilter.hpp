...
* Author : Moin Shaikh
*/
#ifndef FEATUREDETECTION_IMAGEPROCESSING_FILTERING_GRADIENTMAGNITUDEFILTER_HPP_
#define FEATUREDETECTION_IMAGEPROCESSING_FILTERING_GRADIENTMAGNITUDEFILTER_HPP_
